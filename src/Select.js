...
const Select = React.createClass({
	...
	propTypes: {
		...
		hiddenInputValueKey: PropTypes.string // optional key, if you want a specific value rendered in to hidden input
	},
	...
	renderHiddenField (valueArray) {
		...
		const key = this.props.hiddenInputValueKey || this.props.valueKey;
